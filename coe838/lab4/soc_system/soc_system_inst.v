	soc_system u0 (
		...
		.adder_control_0_conduit_end_add_start (<connected-to-adder_control_0_conduit_end_add_start>), // adder_control_0_conduit_end.add_start
		.adder_control_0_conduit_end_add_reset (<connected-to-adder_control_0_conduit_end_add_reset>), //                            .add_reset
		.adder_control_0_conduit_end_add_done  (<connected-to-adder_control_0_conduit_end_add_done>),  //                            .add_done
		.adder_data_0_conduit_end_a_input      (<connected-to-adder_data_0_conduit_end_a_input>),      //    adder_data_0_conduit_end.a_input
		.adder_data_0_conduit_end_b_input      (<connected-to-adder_data_0_conduit_end_b_input>),      //                            .b_input
		.adder_data_0_conduit_end_result       (<connected-to-adder_data_0_conduit_end_result>)        //                            .result
	);
