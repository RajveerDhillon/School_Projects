...
public class FlightTest {
     ...
     */
    @Test
    public void testFlightCons() {
        System.out.println("FlightCons");
        String destination = "";
        String origin = "";
        ...
        instance.FlightCons(destination, origin, originalPrice, capacity, departureTime, flightNumber);
    ...
    public void testGetOrginalPrice() {
        ...
        Flight instance = new Flight();
        int expResult = 0;
        int result = instance.getOrginalPrice();
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
