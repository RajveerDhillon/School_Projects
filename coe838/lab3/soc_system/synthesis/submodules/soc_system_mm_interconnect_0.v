...
// 
// Generated using ACDS version 14.0 209 at 2020.02.25.23:04:24
...
module soc_system_mm_interconnect_0 (
	...
	wire          switch_pio_s1_agent_rdata_fifo_out_valid;                   // switch_pio_s1_agent_rdata_fifo:out_valid -> switch_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] switch_pio_s1_agent_rdata_fifo_out_data;                    // switch_pio_s1_agent_rdata_fifo:out_data -> switch_pio_s1_agent:rdata_fifo_sink_data
	wire          switch_pio_s1_agent_rdata_fifo_out_ready;                   // switch_pio_s1_agent:rdata_fifo_sink_ready -> switch_pio_s1_agent_rdata_fifo:out_ready
	...
	wire          switch_pio_s1_agent_rp_endofpacket;                         // switch_pio_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	wire          switch_pio_s1_agent_rp_valid;                               // switch_pio_s1_agent:rp_valid -> router_004:sink_valid
	wire          switch_pio_s1_agent_rp_startofpacket;                       // switch_pio_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire  [113:0] switch_pio_s1_agent_rp_data;                                // switch_pio_s1_agent:rp_data -> router_004:sink_data
	wire          switch_pio_s1_agent_rp_ready;                               // router_004:sink_ready -> switch_pio_s1_agent:rp_ready
	...
	wire          cmd_mux_002_src_endofpacket;                                // cmd_mux_002:src_endofpacket -> switch_pio_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_002_src_valid;                                      // cmd_mux_002:src_valid -> switch_pio_s1_burst_adapter:sink0_valid
	wire          cmd_mux_002_src_startofpacket;                              // cmd_mux_002:src_startofpacket -> switch_pio_s1_burst_adapter:sink0_startofpacket
	wire  [113:0] cmd_mux_002_src_data;                                       // cmd_mux_002:src_data -> switch_pio_s1_burst_adapter:sink0_data
	wire    [2:0] cmd_mux_002_src_channel;                                    // cmd_mux_002:src_channel -> switch_pio_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_ready;                                      // switch_pio_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	...
	wire    [2:0] switch_pio_s1_burst_adapter_source0_channel;                // switch_pio_s1_burst_adapter:source0_channel -> switch_pio_s1_agent:cp_channel
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (switch_pio_s1_agent_rdata_fifo_out_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (switch_pio_s1_agent_rdata_fifo_out_valid),               //                .valid
		.rdata_fifo_sink_data    (switch_pio_s1_agent_rdata_fifo_out_data),                //                .data
